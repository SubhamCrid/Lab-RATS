...
echo [91m║  ╚═╝  ╚═╝     ╚═╝╚═╝  ╚═══╝╚═════╝  ╚═════╝ ╚═════╝          ║[0m
echo [91m║                                                              ║[0m
echo [91m║                    K4N3CO.LABS APK BUILDER                   ║[0m
echo [91m║                                                              ║[0m
echo [91m╠══════════════════════════════════════════════════════════════╣[0m
...
REM Package Name
echo [95m[^>] Enter Package Name (Application ID) [com.labs.k4n3co]:[0m
set /p "PKG_NAME=    "
if "!PKG_NAME!"=="" set "PKG_NAME=com.labs.k4n3co"

REM App Name
echo [95m[^>] Enter App Name [K4N3CO.LABS]:[0m
set /p "APP_NAME=    "
if "!APP_NAME!"=="" set "APP_NAME=K4N3CO.LABS"
